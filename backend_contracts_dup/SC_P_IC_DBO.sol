...
contract SC_P_IC_DBO
{
    ...
    function claimMoney(address System_Users_Info_address,address SC_P_HA_1_address,address SC_P_DBO_address,uint _policyID, uint _claimedAmount,uint _estimatedBillId,bytes memory _publicKey, bytes32 _commitmentOfSecretKey,address _dboAddr,uint _appID) public
    {
        ...
        claimMoneyCheckConditions(System_Users_Info_address,SC_P_HA_1_address,SC_P_DBO_address,_estimatedBillId,_policyID,_appID,_dboAddr,msg.sender);
      ...
      function claimMoneyCheckConditions(address System_Users_Info_address,address SC_P_HA_1_address,address SC_P_DBO_address,uint _estimatedBillId,uint _policyID,uint _appID,address _dboAddr,address _fnCallerAdress) internal
      {
          ...
          require(SC_P_DBO_instance.applicationToApproval(_appID));
